...
export default reactive({
  baseURLApiServer:(process.env.NODE_ENV=='production')?'https://analysis.api.shaiful.com.bd/api':'http://localhost/arm_analysis_api/public/api',
  baseURLUploadServer:(process.env.NODE_ENV=='production')?'https://analysis.files.shaiful.com.bd/api':'http://localhost/uploads/public/api',
  baseURLUploadedFilesLink:(process.env.NODE_ENV=='production')?'https://analysis.files.shaiful.com.bd':'http://localhost/uploads/public',
